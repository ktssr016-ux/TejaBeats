...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'I want TejaBeats to keep improving.'**
  ...
  /// No description provided for @importTejaBeatsFiles.
  ///
  /// In en, this message translates to:
  /// **'Import TejaBeats Files'**
  String get importTejaBeatsFiles;
