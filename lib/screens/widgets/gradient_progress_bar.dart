...
class GradientProgressBar extends StatefulWidget {
  ...
  const GradientProgressBar({
    ...
    this.onSeek,
    this.activeGradientColors = const [Color(0xFFFF2D78), Color(0xFFE53E3E), Color(0xFFFF6B35)],
    this.inactiveGradientColors = const [Color(0xFFFF2D78), Color(0xFFFF6B35)],
    this.isPlaying = true,
...
class _GradientProgressBarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // 4. Draw ambient neon lighting glow around song progress thumb
    final glowPaint = Paint()
      ..color = const Color(0xFFFF2D78).withValues(alpha: isDragging ? 0.45 : 0.25)
      ..style = PaintingStyle.fill
      ..maskFilter = const MaskFilter.blur(BlurStyle.normal, 10);
    canvas.drawCircle(Offset(thumbX, centerY), thumbRadius * 2.2, glowPaint);
